...
# -rw-rw-r-- 1 pbanerj6 pbanerj6 5.8M Feb 12 19:51 tfidf-omcs-trained.json
# -rw-rw-r-- 1 pbanerj6 pbanerj6 5.9M Feb 12 20:10 tfidf-omcs-sts.json
# -rw-rw-r-- 1 pbanerj6 pbanerj6 5.5M Feb 12 20:22 scapy-omcs-trained.json
# -rw-rw-r-- 1 pbanerj6 pbanerj6 5.8M Feb 12 20:35 scapy-omcs-sts.json
...
# {'best-acc': 0.928, 'val-1': 0.908, 'test-1': 0.91, 'val-2': 0.928, 'test-2': 0.918, 'val-3': 0.918, 'test-3': 0.92, 'val-4': 0.914, 'test-4': 0.918, 'val-5': 0.914, 'test-5': 0.918}

# topk =1 Unmerged After Current-Epoch: {'best-acc': 0.64, 'val-1': 0.594, 'test-1': 0.642, 'val-2': 0.62, 'test-2': 0.666, 'val-3': 0.632, 'test-3': 0.652, 'val-4': 0.64, 'test-4': 0.652, 'val-5': 0.64, 'test-5': 0.648}

# topk=1 Merged After Current-Epoch: {'best-acc': 0.628, 'val-1': 0.59, 'test-1': 0.61, 'val-2': 0.606, 'test-2': 0.618, 'val-3': 0.624, 'test-3': 0.618, 'val-4': 0.628, 'test-4': 0.624, 'val-5': 0.626, 'test-5': 0.622}

# topk=2 Unmerged After Current-Epoch: {'best-acc': 0.652, 'val-1': 0.632, 'test-1': 0.632, 'val-2': 0.648, 'test-2': 0.656, 'val-3': 0.652, 'test-3': 0.662, 'val-4': 0.642, 'test-4': 0.672, 'val-5': 0.644, 'test-5': 0.664}

# topk=2 Merged After Current-Epoch: {'best-acc': 0.624, 'val-1': 0.588, 'test-1': 0.612, 'val-2': 0.624, 'test-2': 0.64, 'val-3': 0.618, 'test-3': 0.658, 'val-4': 0.612, 'test-4': 0.66, 'val-5': 0.612, 'test-5': 0.66}

# topk=3 UnMerged After Current-Epoch: {'best-acc': 0.63, 'val-1': 0.59, 'test-1': 0.614, 'val-2': 0.576, 'test-2': 0.636, 'val-3': 0.62, 'test-3': 0.652, 'val-4': 0.63, 'test-4': 0.658, 'val-5': 0.63, 'test-5': 0.658}

# topk=3 Merged After Current-Epoch: {'best-acc': 0.62, 'val-1': 0.574, 'test-1': 0.59, 'val-2': 0.598, 'test-2': 0.612, 'val-3': 0.614, 'test-3': 0.634, 'val-4': 0.616, 'test-4': 0.63, 'val-5': 0.62, 'test-5': 0.632}


# Methods Max

# After Current-Epoch: {'best-acc': 0.62, 'val-1': 0.574, 'test-1': 0.59, 'val-2': 0.598, 'test-2': 0.612, 'val-3': 0.614, 'test-3': 0.634, 'val-4': 0.616, 'test-4': 0.63, 'val-5': 0.62, 'test-5': 0.632}